...
//        pref[booleanPreferencesKey(ALARM_SWITCH_STATE_KEY)] ?: DEFAULT_SETTINGS.areOn
//    }
//
...
//        pref[intPreferencesKey(FIRST_ALARM_HOURS_KEY)] ?: DEFAULT_SETTINGS.firstAlarmTimeMillis.hour
//    }
//
...
//        pref[intPreferencesKey(FIRST_ALARM_MINUTES_KEY)] ?: DEFAULT_SETTINGS.firstAlarmTimeMillis.minute
//    }
//
...
//        val switchState = this[booleanPreferencesKey(ALARM_SWITCH_STATE_KEY)] ?: DEFAULT_SETTINGS.areOn
//        val numberOfAlarms = this[intPreferencesKey(NUMBER_OF_ALARMS_KEY)] ?: DEFAULT_SETTINGS.numberOfAlarms
//        val firstAlarmHours = this[intPreferencesKey(FIRST_ALARM_HOURS_KEY)] ?: DEFAULT_SETTINGS.firstAlarmTimeMillis.hour
//        val firstAlarmMinutes = this[intPreferencesKey(FIRST_ALARM_MINUTES_KEY)] ?: DEFAULT_SETTINGS.firstAlarmTimeMillis.minute
//        val minutesBetweenAlarms = this[intPreferencesKey(MINUTES_BETWEEN_ALARMS_KEY)] ?: DEFAULT_SETTINGS.minutesBetweenAlarms
//        return AlarmSettings(
//                areOn = switchState,
//                firstAlarmTimeMillis = LocalTime.of(firstAlarmHours, firstAlarmMinutes),
...
//        dataStore.edit { pref ->
//            pref[intPreferencesKey(NUMBER_OF_ALREADY_RANG_ALARMS_KEY)] = numberOfAlreadyRangAlarms
//        }
//    }
//
//    fun getNumberOfAlreadyRangAlarms() = dataStore.data.map { pref ->
//        pref[intPreferencesKey(NUMBER_OF_ALREADY_RANG_ALARMS_KEY)] ?: DEFAULT_NUMBER_OF_ALREADY_RANG_ALARMS
//    }
//
//    companion object {
